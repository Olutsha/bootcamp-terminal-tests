...
describe('The mostProfitableDepartment function', function(){
    it('This should return Most profitable department is outdoor for dataset 1 when called with salesData ', function(){
        assert.equal('outdoor', mostProfitableDepartment(salesData), "Most profitable department is 'outdoor' for dataset 1");
    });
   
    it('This should return Most profitable department is electronics for dataset 2 when called with salesData2 ', function(){
